extends Node2D
class_name MockEnemyBase
## Auto-generated mock for Node2D
...
func take_damage(amount, type):
	_calls.append({"method": "take_damage", "args": [amount, type]})
	if _return_values.has("take_damage"):
		return _return_values["take_damage"]
	return null
